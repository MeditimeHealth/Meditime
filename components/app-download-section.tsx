      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          >
            ...
            {/* Store buttons — DESKTOP ONLY here */}
            <div className="hidden lg:flex flex-col gap-3 w-fit">
              <a
                href="#"
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  <span className="text-[10px] text-gray-300 uppercase tracking-wide">
                    {language === "en" ? "GET IT ON" : "ডাউনলোড করুন"}
                  </span>
                  <span className="text-sm font-bold">{t.playStore}</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  <span className="text-[10px] text-gray-300 uppercase tracking-wide">
                    {language === "en" ? "Download on the" : "ডাউনলোড করুন"}
                  </span>
          ...
          {/* RIGHT — QR code: DESKTOP ONLY / Store buttons: MOBILE ONLY */}
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="flex flex-col items-center lg:items-end gap-3 order-3"
          >
            {/* Store buttons — MOBILE ONLY here */}
            <div className="flex lg:hidden flex-col gap-3 w-fit mt-4">
              <a
                href="#"
                className="flex items-center gap-3 bg-slate-900 hover:bg-slate-800 text-white px-5 py-3 rounded-xl transition-all w-48"
              >
