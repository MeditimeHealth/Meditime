            ...
            <div className="flex flex-col gap-3 w-fit">
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  <span className="text-[8px] md:text-[10px] text-gray-300 uppercase tracking-wide">
                    {language === "en" ? "GET IT ON" : "ডাউনলোড করুন"}
                  </span>
                  <span className="text-[10px] md:text-[16px] font-bold">{t.playStore}</span>
                </div>
              </a>
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  ...
                  <span className="text-[10px] md:text-[16px] font-bold">{t.appStore}</span>
                </div>
              </a>
            </div>
          </motion.div>
