...
export const translations = {
  en: {
    ...
    serialAffiliateCodeLabel: "Serial/Affiliate Code (Optional)",
    serialAffiliateCodePlaceholder: "Enter serial or affiliate code",
  ...
  bn: {
    ...
    serialAffiliateCodeLabel: "সিরিয়াল/অ্যাফিলিয়েট কোড (ঐচ্ছিক)",
    serialAffiliateCodePlaceholder: "সিরিয়াল বা অ্যাফিলিয়েট কোড লিখুন",
    enterReferralCode: "রেফারেল কোড থাকলে এখানে লিখুন",
