          ...
          {ambulances.map((ambulance) => (
            <Card key={ambulance._id} className="p-6">
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">{ambulance.name}</h3>
                  <p className="text-sm text-gray-600 mt-1">Vehicle Type: <span className="font-semibold text-primary">{ambulance.vehicleType}</span></p>
                </div>

                <div className="space-y-2 text-sm">
                  <div>
                    <span className="text-gray-600">Phone: </span>
                    <span className="text-gray-900">{ambulance.phoneNumber}</span>
                  </div>
                  ...
                  <div>
                    ...
                    <span className={`font-medium ${
                      ambulance.availabilityStatus === "Available" ? "text-green-600" :
                      ambulance.availabilityStatus === "On Call" ? "text-yellow-600" :
                      "text-red-600"
                    }`}>
