      ...
      >
        <Providers>
          ...
          <a
            ...
            className="fixed bottom-24 right-5 z-50 w-12 h-12 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 group"
