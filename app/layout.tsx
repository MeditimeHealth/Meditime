      ...
      >
        <Providers>
          ...
          <a
            ...
            className="fixed bottom-24 print:hidden right-8 z-50 w-12 h-12 bg-[#3DB5A0] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-all duration-300 group"
