            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
              <div className="flex items-center gap-4 flex-wrap">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 border-2 border-primary/30 shadow-md hover:shadow-lg transition-all bg-white"
                    style={{
                      fontFamily:
                        "'Kalpurush', 'SolaimanLipi', 'Siyam Rupali', sans-serif",
                    }}
                  >
                    ...
                    {showFilters
                      ? banglaLabels.hideFilters
                      : banglaLabels.showFilters}
                    {hasActiveFilters && (
                      <motion.span
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        className="bg-gradient-to-r from-primary to-primary-dark text-white rounded-full px-3 py-1 text-xs font-semibold ml-2"
                      >
                        {banglaLabels.active}
                      </motion.span>
                    )}
                ...
                {hasActiveFilters && (
                  ...
                  >
                    <Button
                      ...
                      className="flex items-center gap-2 px-5 py-2.5 border-2 border-red-300 text-red-600 hover:bg-red-50 shadow-md hover:shadow-lg transition-all"
                      style={{
                        fontFamily:
                          "'Kalpurush', 'SolaimanLipi', 'Siyam Rupali', sans-serif",
                      }}
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <select
                  ...
                  className="px-4 py-2.5 border-2 border-gray-300 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary shadow-sm hover:shadow-md transition-all bg-white"
                  style={{
                    fontFamily:
                      "'Kalpurush', 'SolaimanLipi', 'Siyam Rupali', sans-serif",
                  }}
                >
                  ...
                  <option value="hospital">{banglaLabels.hospital}</option>
                </select>
                <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Button
                    ...
                    className="px-4 py-2.5 border-2 border-primary/30 shadow-md hover:shadow-lg bg-white"
                  >
                    {sortDirection === "asc" ? "↑" : "↓"}
                  </Button>
                </motion.div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {searchQuery && getMatchedFields(doctor).length > 0 && (
                          <div className="mt-2 flex flex-wrap gap-1">
                            ...
                            >
                              {banglaLabels.matched}:
                            </span>
                            {getMatchedFields(doctor).map((field, idx) => (
                              <span
                                key={idx}
